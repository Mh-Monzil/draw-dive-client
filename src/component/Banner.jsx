...
const Banner = () => {
  ...
  return (
    <div>
      ...
      >
        <SwiperSlide className="relative">
          <div style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${bgImage1})`}} className=" flex flex-col items-center justify-center w-full h-full text-white  bg-cover bg-center -z-10">
    ...
    data-aos-easing="ease-in-out" className="text-lg font-semibold md:max-w-[900px] text-center py-4">
            A guide to enhancing your creative skills through exploration, expression, and personal growth, designed to inspire innovation and artistic development.
            </p>
            <div data-aos="fade-up"
    data-aos-duration="400"
    data-aos-easing="ease-in-out" className="flex items-center gap-8 mt-10">
              <button className="px-4 py-2 md:px-7 md:py-3  bg-[#E76F51] border-2 border-[#E76F51] hover:bg-transparent hover:border-white rounded-[50px] text-lg font-semibold md:font-bold ease-in-out duration-300">Our Services</button>
              <button className="px-4 py-2 md:px-7 md:py-3 bg-transparent border-2 hover:bg-[#E76F51] hover:border-[#E76F51] rounded-[50px] text-lg font-semibold md:font-bold ease-in-out duration-300">Our Feedback</button>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide className="relative">
          <div  style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${bgImage2})`}} className=" flex flex-col items-center justify-center w-full h-full text-white  bg-cover bg-center">
            ...
            A captivating exploration of art's power, highlighting personal tales and emotions captured in each meticulous, expressive brushstroke on canvas.
            </p>
        ...
        <SwiperSlide className="relative">
          <div  style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${bgImage3})`}} className=" flex flex-col items-center justify-center w-full h-full text-white  bg-cover bg-center">
            ...
            <p className="text-lg font-semibold md:max-w-[900px] text-center px-8 py-4">
            A vivid exploration of how artistic expression transforms abstract visions into tangible, visually stunning works of art on canvas.
            </p>
            <div className="flex items-center gap-8 mt-10">
            <button className="px-4 py-2 md:px-7 md:py-3  bg-[#E76F51] border-2 border-[#E76F51] hover:bg-transparent hover:border-white rounded-[50px] text-lg font-semibold md:font-bold ease-in-out duration-300">Our Services</button>
              <button className="px-4 py-2 md:px-7 md:py-3 bg-transparent border-2 hover:bg-[#E76F51] hover:border-[#E76F51] rounded-[50px] text-lg font-semibold md:font-bold ease-in-out duration-300">Our Feedback</button>
